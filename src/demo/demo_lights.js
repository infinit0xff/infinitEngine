/*
 * File: Demo_Lights: support the creation of light for Demo
 */
/*jslint node: true, vars: true */
/*global gEngine, Demo, Light, LightSet */
/* find out more about jslint: http://www.jslint.com/help.html */

"use strict";  // Operate in Strict mode such that variables must be declared before used!

Demo.prototype._createALight = function (type, pos, dir, color, n, f, inner, outer, intensity, dropOff) {
    var light = new Light();
...
Demo.prototype._initializeLights = function () {
    this.ivGlobalLightSet = new LightSet();
    ...
    this.ivGlobalLightSet.addToSet(l);
