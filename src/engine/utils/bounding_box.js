...
BoundingBox.prototype.setBounds = function (centerPos, w, h) {
    this.ivWidth = w;
    this.ivHeight = h;
    this.ivLL[0] = centerPos[0] - (w / 2);
    this.ivLL[1] = centerPos[1] - (h / 2);
};
...
BoundingBox.prototype.minX = function () { return this.ivLL[0]; };
BoundingBox.prototype.maxX = function () { return this.ivLL[0] + this.ivWidth; };
BoundingBox.prototype.minY = function () { return this.ivLL[1]; };
BoundingBox.prototype.maxY = function () { return this.ivLL[1] + this.ivHeight; };